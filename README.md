...
```
    roslaunch vins vins_rviz.launch
    rosrun vins vins_node src/VINS-Fusion/config/xp_cam/xp_stereo_imu_config.yaml
    (optional) rosrun loop_fusion loop_fusion_node src/VINS-Fusion/config/xp_cam/xp_stereo_imu_config.yaml.yaml 
    rosbag play YOUR_DATASET_FOLDER/car.bag
```
