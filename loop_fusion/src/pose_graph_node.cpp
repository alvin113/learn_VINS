...
ros::Publisher pub_match_points;//// CZJ
...
int main(int argc, char **argv)
{
    ...
    fsSettings["fast_relocalization"] >> FAST_RELOCALIZATION;////CZJ
    ...
    pub_match_points = n.advertise<sensor_msgs::PointCloud>("match_points", 100);////CZJ
